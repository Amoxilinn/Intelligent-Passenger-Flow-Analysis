...
function initRuntimeSocketService() {
  const hosts = "192.168.0.66,192.168.247.1,192.168.2.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_owjy4g";
