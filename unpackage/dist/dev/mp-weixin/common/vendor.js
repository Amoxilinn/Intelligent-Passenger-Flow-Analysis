...
function initRuntimeSocketService() {
  const hosts = "192.168.31.78,192.168.247.1,192.168.2.1,127.0.0.1";
  const port = "8090";
  const id = "mp-weixin_O9K_Ic";
...
const pages = [
  ...
  {
    path: "pages/mode-select/mode-select",
    style: {
      navigationBarTitleText: "",
      navigationStyle: "custom",
      navigationBarTextStyle: "white"
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.31.78","192.168.247.1","192.168.2.1"],"servePort":7000,"debugPort":9000,"initialLaunchType":"remote","skipFiles":["<node_internals>/**","D:/HBuilderX.4.87/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"smart-analysis","spaceId":"mp-742d60eb-ec71-4caf-b0c9-2fae3353cf09","clientSecret":"iKGUBFFJJL9cesrUiDjeeg==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__0D4C11F";
} catch (e2) {
